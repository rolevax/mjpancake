...
var blabla = {
    ...
    "<ul>" +
    "<li>容易连续和牌且火力不断上升</li>" +
    "<li>和牌被打断后火力需重新从低点涨起</li>" +
    "<li>和牌速度与点数无关，任何情况下都容易在早巡和牌</li>" +
    "</ul>" +
    "<h3>（*）王者的余裕</h3>" +
    "<ul>" +
    ...
    "<h3>序盘支配</h3>" +
    "<ul>" +
    "<li>除自己外，全员配牌五/六向听</li>" +
    "</ul>" +
    "<h3>自动麻将机</h3>" +
    "<ul>" +
    "<li>每局都可以有意识地做到双立直</li>" +
    "<li>该意识下会在牌山末转角前摸到杠材</li>" +
    "<li>暗杠后和了牌会从末转角开始处连续出现</li>" +
    "<li>双立直暗杠和了后暗杠将中为4张杠里宝牌</li>" +
    "</ul>"
    ,
    "710411":
    "<h3>（*）好棒</h3>" +
    ...
    "<h3>（*）魑魅魍魉</h3>" +
    "<ul>" +
    "<li>保有全国大会史上最高火力纪录</li>" +
    "<li>节奏变化快，从早巡到海底都很擅长</li>" +
    "<li>控场之严犹如无法摆脱的命运</li>" +
    "<li>时间越接近满月的夜晚支配力越强</li>" +
    "</ul>" +
    "<h3>（*）恶趣味</h3>" +
    "<ul>" +
    "<li>无法宣告只击飞一家的和牌</li>" +
    "<li>有一定几率因弄坏闹钟导致骑马</li>" +
    "</ul>" +
    "<h3>（*）牌风</h3>" +
    "<ul>" +
    "<li>容易做出古役满</li>" +
    ...
    "<li>部分能力即使本尊不在场也无法复制，例如：<ul>" +
        ...
        "<li>记忆宫殿、枕神、神威等需要事前特殊准备的能力</li></ul></li>" +
    "<li>东风之神等需要食物的能力复制后仍然需要相应的食物</li>" +
    "<li>风神、爆发、暖牌等能力复制后牌山资源会与同场本尊以同等强度争抢</li>" +
    "<li>两个隐身者之间无法感觉到对方存在</li>" +
    "<li>两个决斗者互相伤害，结果五五开</li>" +
    "<li>两台自动桌同时W立，杠里宝牌优先指向和牌者，双响则五五开</li>" +
